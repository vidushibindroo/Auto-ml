...
def random_forest_algorithm(train_df,task, n_trees, n_bootstrap, n_features, dt_max_depth):
    forest = []
    for i in range(n_trees):
        df_bootstrapped = bootstrapping(train_df, n_bootstrap)
        tree = decision_tree_algorithm(df_bootstrapped,ml_task=task,max_depth=dt_max_depth, random_subspace=n_features)
        forest.append(tree)
...
forest = random_forest_algorithm(x,task='C',n_trees=4, n_bootstrap=100, n_features=2, dt_max_depth=4)
